...
public class ElementUtil {
	...
	@Step("Finding the element using the locator: {0}")
	...
	private void highlightElement(WebElement element) {
		if(Boolean.parseBoolean(DriverFactory.highlight)) {
			System.out.println("highlight value is: "+ DriverFactory.highlight);
	 ...
	 * @return
	 */
	@Step("Waiting for element using: {0} and the wait time is : {1}")
	 ...
	 * @param timeOut
	 */
	@Step("waiting on element for: {1} and clicking on element using : {0}")
